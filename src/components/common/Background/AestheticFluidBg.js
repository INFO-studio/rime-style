      ...
      n(r, [
        ...
        },
        {
          ...
          value: function (t, e, i, r) {
            return t.length
              ? this.copy(t)
              : (Z(this._target, t, e, i, r), this.onChange(), this);
          },
        },
        {
          key: 'rotateX',
          ...
          value: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : this._target;
            return (K(this._target, t), this.onChange(), this);
          },
        },
        {
          key: 'multiply',
          value: function (t, e) {
            return (
              e ? Y(this._target, t, e) : Y(this._target, this._target, t),
              this.onChange(),
              this
            );
          },
    ...
    n(r, [
      ...
      },
      {
        ...
        value: function (t, e, i, r, n, s, a, h, o, u, l, c, d, f, g, v) {
          return t.length
            ? this.copy(t)
            : ((function (t, e, i, r, n, s, a, h, o, u, l, c, d, f, g, v, p) {
                ((t[0] = e),
                  (t[1] = i),
                  (t[2] = r),
                  (t[3] = n),
    ...
    return (
      ...
      n(r, [
        ...
        },
        {
          ...
          value: function (t) {
            return (
              t.applyMatrix4(lt.inverse(this.projectionMatrix)),
...
var vt = (function (t) {
    function r() {
      ...
      return (i(this, r), u((t = e(this, r, [n, s, a, h, o, l, c, d, f])), t));
    }
    return (
      h(r, v(Array)),
      n(r, [
        ...
        },
        {
          key: 'multiply',
          value: function (t, e) {
            return (e ? gt(this, t, e) : gt(this, this, t), this);
          },
        },
        {
          key: 'identity',
            ...
            if (
              ...
              if (
                ...
                (this.generateMipmaps &&
                  ...
                  (_t(this.image.width) && _t(this.image.height))
        ...
        for (var O = [], B = 0; B < c; B++)
          (this.textures.push(
            ...
            this.gl.framebufferTexture2D(
              this.target,
              this.gl.COLOR_ATTACHMENT0 + B,
              this.gl.TEXTURE_2D,
              this.textures[B].texture,
              0
            ),
  ...
  Rt = (function (t) {
    function r(t) {
      ...
      return (
        ...
        Array.isArray(t)
          ? u(n, (n = e(this, r, c(t))))
          : u(n, (n = e(this, r, c(kt.apply(Tt, arguments)))))
      );
    }
    return (
      h(r, v(Array)),
        ...
        },
        {
          ...
          value: function (t) {
            return Array.isArray(t)
              ? this.copy(t)
              : this.copy(kt.apply(Tt, arguments));
          },
        },
        {
          key: 'copy',
...
var Ot = (function (t) {
  ...
  Bt = (function (t) {
    function r() {
      ...
      return (i(this, r), u((t = e(this, r, [n, s, a, h])), t));
    }
    return (
      h(r, v(Array)),
      n(r, [
            ...
            var e =
              ...
              r =
                arguments.length > 3 && void 0 !== arguments[3]
                  ? arguments[3]
                  : t;
            return t.length ? this.copy(t) : (q(this, t, e, i, r), this);
          },
        },
        {
          key: 'copy',
...
!(function () {
  !(function (t, e, i) {
    ...
    if (
      (v(i.random(), e),
      'object' == ('undefined' == typeof module ? 'undefined' : f(module)) &&
        module.exports)
    ) {
      module.exports = l;
      try {
    ...
    (this.surround = function (t) {
      ...
      for (var i = 0, r = this.posAttribute.count; i < r; i++) {
        ...
        if (!(0 == n || 99 == n || i < 100 || (i > 9900 && i < 1e4))) {
          var s = new R(
            this.posAttribute.getX(i),
            this.posAttribute.getY(i),
            this.posAttribute.getZ(i)
          );
          if ((e = s.distance(this.anchor)) < this.effectradius) {
            var a = new R(
                this.posAttribute.getX(n),
                this.posAttribute.getY(n),
                this.posAttribute.getZ(n)
              ),
              h = new R(
                this.posAttribute.getX(n + 9900),
                this.posAttribute.getY(n + 9900),
                this.posAttribute.getZ(n + 9900)
              ),
              o = s.distance(a),
              u = s.distance(h),
              l = 5 / Math.min(o, u),
              ...
              d =
                ((1 / (0.25 * Math.sqrt(6.28))) * Math.exp((-c * c) / 0.125)) /
                1.6;
      ...
      if (this.anchor.x !== t || this.anchor.y !== e || this.anchor.z !== i) {
        ...
        (this.map.forEach(function (t, e, i) {
          var h = r.getX(e),
            o = r.getY(e),
            u = r.getZ(e);
          t > 0.001 && r.setXYZ(e, h + n * t, o + s * t, u + a * t);
        }),
...
var Lt = (function (t) {
  function r() {
    ...
    return (
      i(this, r),
      ((t = e(this, r, [n, 6])).name = 'aesthetic-fluid'),
      (t.options.radius_inner = n.radius_inner || 0.1),
      (t.options.radius_outer = n.radius_outer || 0.3),
      (t.morphdata = {
        1: {
          anchorX: 240,
          anchorY: -200,
  ...
  return (
    ...
    n(r, [
      ...
      },
      {
        key: '_initRtt',
        value: function () {
          ((this.rtt = new Et(this.gl, { width: 512, height: 512 })),
            ...
            (this.rttProgram = new N(this.gl, {
              ...
              uniforms: {
                ...
                u_color_0: { value: new Rt(this.palette[0]) },
                u_color_1: { value: new Rt(this.palette[1]) },
                u_color_2: { value: new Rt(this.palette[2]) },
                u_color_3: { value: new Rt(this.palette[3]) },
                u_color_4: { value: new Rt(this.palette[4]) },
                u_color_5: { value: new Rt(this.palette[5]) },
                u_dye_0: { value: new Bt(0.3, 0.8, 0.1, 0.7) },
                u_dye_1: { value: new Bt(0.7, 0.8, 0.1, 0.7) },
                u_dye_2: { value: new Bt(0.7, 0.2, 0.1, 0.7) },
                u_dye_3: { value: new Bt(0.3, 0.2, 0.1, 0.7) },
                u_dye_4: { value: new Bt(0.1, 0.5, 0.1, 0.45) },
                u_dye_5: { value: new Bt(0.9, 0.5, 0.1, 0.45) },
              },
            })),
        ...
        value: function () {
          for (var t = 0; t < 6; t++) {
            var e = this.rng(),
              i = this.rng(),
              r =
                this.rng() * this.options.radius_inner +
                this.options.radius_inner,
              n =
                this.rng() * this.options.radius_outer +
                this.options.radius_outer,
              s = new Bt(e, i, r, n);
      ...
      },
      {
        ...
        value: function () {
          ...
          new mt(this.gl, { geometry: t, program: this.planeShader }).setParent(
            this.scene
          );
      ...
      },
      {
        ...
        value: function () {
          ((this.rttProgram.uniforms.u_color_0.value = new Rt(this.palette[0])),
            (this.rttProgram.uniforms.u_color_1.value = new Rt(
              this.palette[1]
            )),
            (this.rttProgram.uniforms.u_color_2.value = new Rt(
              this.palette[2]
            )),
            (this.rttProgram.uniforms.u_color_3.value = new Rt(
              this.palette[3]
            )),
            (this.rttProgram.uniforms.u_color_4.value = new Rt(
              this.palette[4]
            )),
            (this.rttProgram.uniforms.u_color_5.value = new Rt(
              this.palette[5]
            )));
        },
      },
